                  ...
                  <div className="section">
                    <div className="content">
                      <div className="title-content">
                        <p className="title">
                          <span className="title-highlight">코로나</span>
                          와&nbsp;
                          <span className="title-highlight">배달</span>의 상관
                          관계
                        </p>
                      </div>
                      <div className="eachContent1">
                        <div className="text-content1">
                          <p className="text1">
                            코로나가 발생한 이후, 세상에는 많은 변화가
                            생겼습니다.
                          </p>
                          <p className="text2">
                            오프라인에서 사람을 만나는 것이 어려워졌으며
                            <br />
                            마스크 없이는 밖에 나갈 수 없고 <br />
                            음식점에서 식사조차 마음 편히 할 수 없습니다.
                            <br />
                          </p>
                          <p className="text2">
                            그렇기에 배달은 우리와 떨어질수 없는 각별한 사이가
                            됐죠.
                            <br />
                            생활의 변화 중&nbsp;
                    ...
                    <div className="content">
                      <div className="title-content">
                        <p className="title">
                          ...
                          <span className="title-highlight">건강</span>의
                          상관관계
                        </p>
                      </div>
                      <div className="eachContent2">
                        <div className="gainWeight-content">
                          ...
                          <div className="gainWeight-text">
                            <p className="text3">
                              그렇다면 코로나 확산, 배달 주문 증가에 따른
                              사람들의 건강은 어떻게 변했을까요?
                            </p>
                            <p className="text4" style={{ textAlign: "right" }}>
                              코로나 시기 동안 성인 남녀 중 3kg 이상 체중이
                              늘었다고 답한 비율이 무려&nbsp;
                        ...
                        <div className="dietRate-content">
                          <div className="dietRate-text">
                            <p className="text4" style={{ textAlign: "left" }}>
                              코로나 시국에 찐 살을 빼기 위해 현재{" "}
                              <span style={{ fontWeight: "bold" }}>
                                다이어트
                              </span>
                              를 하고 있거나 <br />
                              계획하고 있다는 응답 비율은{" "}
                              <span style={{ fontWeight: "bold" }}>93.4%</span>
                              나 되며
                            </p>
                            <p
                              className="quotation"
                            ...
                            <p className="text4" style={{ textAlign: "left" }}>
                              ...
                              결과에서는
                              <br />
                              2019년도 비해 대부분의 시도에서 2020년도에{" "}
                              <span style={{ fontWeight: "bold" }}>증가</span>
                              하였습니다.
                            </p>
                            <p
                              className="quotation"
                      ...
                      <div className="eachContent3">
                        <div className="keyword-text">
                          ...
                          <p className="text2" style={{ fontWeight: "bold" }}>
                            코로나가 증가 추세에 따라 ‘건강’ 및 ‘운동’ 에 대한{" "}
                            <br />
                            관심이 높아짐을 알 수 있습니다.
                          </p>
                        </div>
                        <div
                          className="chartKeyword"
                    ...
                    <div className="content">
                      <div className="title-content">
                        <p className="title">
                          ...
                          <span className="title-highlight">2030</span>을
                          선택했나
                        </p>
                      </div>
                      <div className="eachContent4">
                        <p className="text1">
                          <span
                            style={{ fontWeight: "bold", color: "#47c690" }}
                          >
                            오늘의 공원
                          </span>
                          은 왜 20대, 30대 선택했을까요?
                        ...
                        <p className="text4">
                          ...
                          를 이용하여&nbsp;
                          <span style={{ fontWeight: "bold" }}>“확찐자”</span>가
                          된 사람들을 위해서 서비스를 제공합니다.
                        </p>
                        <p className="text4">
                          코로나19 이전 대비&nbsp;
                          <span style={{ fontWeight: "bold" }}>체중 증가</span>
                          를 가장 많이 겪은 연령대는 30대이며, 근소한 차이로
                          40대와 20대가 위치합니다.
                        </p>
                        <p className="quotation">(대한비만학회)</p>
                        <p className="text4" style={{ fontWeight: "bold" }}>
                          배달 서비스를 가장 많이 이용하고 코로나 시기 동안 체중
                          증가를 가장 많이 겪은 20대, 30대를 기준으로 서비스를
                          제공하기로 했습니다.
                        </p>
                        <div className="gwanak-charts">
                          <div
                            className="chartGainWeightByAge"
                            style={{
                              width: "300px",
                              height: "200px",
                              marginBottom: "30px",
                          ...
                          <div
                            className="chartDeliverPercentByAge"
                            style={{
                              width: "300px",
                              height: "300px",
                              marginBottom: "30px",
                    ...
                    <div className="content">
                      ...
                      <div className="eachContent5">
                        ...
                        <div className="chart2030-text">
                          <p className="text2">
                            서울시 연령대별 인구 조사를 바탕으로
                            <br />
                            구별 20대, 30대 비율을 분석한 결과
                            <br />
                            <span style={{ fontWeight: "bold" }}>
                              관악구, 광진구, 영등포구
                            </span>{" "}
                          ...
                          <p className="text2">
                            특히{" "}
                            <span style={{ fontWeight: "bold" }}>관악구</span>는
                            40%로 광진구(34%), 영등포구(33%)에 비해서 <br />
                            <span style={{ fontWeight: "bold" }}>압도적</span>인
                            수치를 보였습니다.
                          </p>
                        </div>
                      </div>
